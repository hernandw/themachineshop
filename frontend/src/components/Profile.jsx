...
export const Profile = ({img, name, position, socialTwitter, socialGithub, socialLinkedin}) => {
	return (
		...
		<img
			className="card__person-profile"
			src={img}
			alt=""
		/>
		...
		<div className="card__person-icon">
			<a href={socialTwitter} target="_blank"><FaTwitter /></a>
			<a href={socialGithub} target="_blank"><FaGithub /></a>
			<a href={socialLinkedin} target="_blank"><FaLinkedinIn /></a>
		</div>
	</div>
	)
}
